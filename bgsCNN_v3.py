...
class bgsCNN_v3:
    ...
    def build_model(self):
        ...
        with tf.name_scope("feature_reduction"):
            # shape: 21X21X26
            net = pool3d(net, [1,48,1,1,1], [1,25,1,1,1], 'avg')
            net = pool3d(net, [1,6,1,1,1], [1,3,1,1,1], 'avg')
        with tf.name_scope("deconv_1"):
            # shape: 81X81X16
            W_deconv1 = weight([1, 1, 16, 26], "weights")
            deconv_1 = deconv2d(net, W_deconv1,
                output_shape = [self.batch_size, 81, 81, 16], strides = [1, 4, 4, 1])
        ...
        with tf.name_scope("deconv_2"):
            ...
            deconv_2 = deconv2d(deconv_1, W_deconv2,
                output_shape = [self.batch_size, 165, 165, 8], strides = [1, 2, 2, 1])
        ...
        with tf.name_scope("deconv_3"):
            ...
            deconv_3 = deconv2d(deconv_2, W_deconv3,
                output_shape = [self.batch_size, 333, 333, 4], strides = [1, 2, 2, 1])
